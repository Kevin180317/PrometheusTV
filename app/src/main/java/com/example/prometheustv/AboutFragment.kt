...
class AboutFragment : Fragment() {
    override fun onCreateView(
        ...
        description.text = "Bienvenido a Departamento Tortuga, un espacio diseñado para tu comodidad y descanso en Mazatlán.\n\nEsperamos que disfrutes tu estadía tanto como nosotros disfrutamos compartir nuestro hogar contigo."
